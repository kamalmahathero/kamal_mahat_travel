              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form action="action.php" method="post">
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example17" class="form-control form-control-lg" name="mail" />
                  ...
                  <div class="pt-1 mb-4">
                    <input class="btn btn-dark btn-lg btn-block" type="submit" name="login" value="Login" />                  </div>
